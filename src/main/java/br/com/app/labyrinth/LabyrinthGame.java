package br.com.app.labyrinth;

import br.com.app.game.Global;
import br.com.app.game.IGame;
import br.com.app.labyrinth.io.LabyrinthReader;
import br.com.app.labyrinth.model.Labyrinth;
import br.com.app.labyrinth.model.LabyrinthCurve;
import br.com.app.labyrinth.model.LabyrinthPoint;
import br.com.app.labyrinth.model.Vehicle;
import br.com.app.primitive.*;
...
//             Labyrinth level = LabyrinthReader.readFromJson("src/main/resources/levels/level1.json");
    ...
    public void update() {
        ...
        for(Vehicle enemy: enemies) {
            ...
            if(skippedFrames++ > 60 && player.hasCollision(enemy)) {
